    ...
    public partial class mig_1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 27, 20, 11, 7, 343, DateTimeKind.Local).AddTicks(9579), "İçecek", 1, null },
                    { 2, new DateTime(2023, 11, 27, 20, 11, 7, 343, DateTimeKind.Local).AddTicks(9581), "Patates", 1, null },
                    { 3, new DateTime(2023, 11, 27, 20, 11, 7, 343, DateTimeKind.Local).AddTicks(9582), "Tatlı", 1, null },
                    { 4, new DateTime(2023, 11, 27, 20, 11, 7, 343, DateTimeKind.Local).AddTicks(9584), "Atıştırmalık", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 27, 20, 11, 7, 343, DateTimeKind.Local).AddTicks(9951), 1, "About", null },
                    { 2, new DateTime(2023, 11, 27, 20, 11, 7, 343, DateTimeKind.Local).AddTicks(9954), 1, "Contact", null },
                    { 3, new DateTime(2023, 11, 27, 20, 11, 7, 343, DateTimeKind.Local).AddTicks(9955), 1, "General", null },
                    { 4, new DateTime(2023, 11, 27, 20, 11, 7, 343, DateTimeKind.Local).AddTicks(9957), 1, "Exception", null },
                    { 5, new DateTime(2023, 11, 27, 20, 11, 7, 343, DateTimeKind.Local).AddTicks(9958), 1, "UIMessagges", null },
                    { 6, new DateTime(2023, 11, 27, 20, 11, 7, 343, DateTimeKind.Local).AddTicks(9960), 1, "AdminMessagges", null }
                });
